...
Companion docs in this dir: `README.md` (§5–§8 designs + decisions),
`threedep_source_map.md` (source layers + Southern_4 Rosetta-stone case),
`laz_vs_ept_study.md` (LAZ/EPT defaults + auto-selection recommendation),
`ept_wesm_mapping.csv` (archive-wide name resolution, tier-labeled).
